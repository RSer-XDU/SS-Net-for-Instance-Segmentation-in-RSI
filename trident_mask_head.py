...
class TriMaskHead(nn.Module):
    ...
    def __init__(self,
        ...
        super(TriMaskHead, self).__init__()
        ...
        self.conv_logits1 = nn.Conv2d(self.conv_out_channels  , out_channels, 1)
        self.conv_logits2 = nn.Conv2d(self.conv_out_channels , out_channels, 1)
        self.conv_logits3 = nn.Conv2d(self.conv_out_channels  , out_channels, 1)
        self.conv_logits_refine = nn.Conv2d(logits_in_channel, out_channels, 1)
