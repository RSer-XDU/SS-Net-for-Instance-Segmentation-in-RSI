...
@HEADS.register_module
class SplitConvBBoxHead(ConvFCBBoxHead):

    def __init__(self, num_cls_convs=3,  num_reg_convs=3, fc_out_channels=1024, *args, **kwargs):
        assert num_cls_convs >= 1 and  num_reg_convs >=1
        super(SplitConvBBoxHead, self).__init__(
            num_shared_convs=0,
            num_shared_fcs=0,
